<div class="flex w-full h-screen bg-linear-to-b from-v6 from-5% to-95% to-v5">
    ...
    <div class="flex flex-col w-full max-h-dvh overflow-hidden overflow-y-auto no-scrollbar mx-2 md:mx-7 lg:mx-14 pt-7 relative">
        ...
        <div id="action" class="pb-7 pt-4 gap-7 bg-v5 sticky bottom-0 hidden">
            <button hx-post="/" hx-target="#menu" hx-vals='{"id": "keranjang"}' name="actionMenu" type="button" class="border-2 border-v1 bg-v5 text-v1 text-base w-full hover:bg-v1 hover:text-v5 shadow-sm/40 rounded-xl px-8 py-2 transform transition-all duration-250 active:scale-95 active:shadow-inner">keranjang</button>
            <button hx-post="/" hx-target="#menu" hx-vals='{"id": "bayar"}' name="actionMenu" type="button" class="w-full text-base bg-v1 hover:bg-orange-500 shadow-sm/40 rounded-xl text-v5 px-8 py-2 transform transition-all duration-250 active:scale-95 active:shadow-inner">bayar</button>
        </div>
    </div>
    <aside
        id="sidebar"
        ...
        <button hx-post="/kasir" hx-target="#menu" hx-vals='{"bayar": 1 }' name="actionMenu" type="button" class="w-full my-5 text-base bg-v1 hover:bg-orange-500 shadow-sm/40 rounded-xl text-v5 px-8 py-2 transform transition-all duration-250 active:scale-95 active:shadow-inner">bayar</button>
    </aside>
</div>