<div
    ...
    <form
        ...
        <div class="flex flex-col gap-4">
            ...
            <label for="daftar" class="text-xs text-center text-v3/50 font-semibold">Belum punya akun? <a id="daftar" href="/auth/register" class="italic text-v2/65">Daftar di sini</a></label>
        </div>
